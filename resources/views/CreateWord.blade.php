                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            @foreach($data as $levels)
                                                <option name="H1" value="{{$levels->Level}}">{{$levels->Level}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="Language"
                                                value="LPC" id="inlineRadio1" value="option1" checked>LPC
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="Language"
                                                value="LSF" id="inlineRadio1" value="option2">LSF
                                        </label>
                                    </div>
                                    <div class="form-group mt-3">
                                        <label for="exampleInputEmail1">Images LPC</label>
                                        <div class="custom-file">
                                            <input id="input-2" name="images[]" type="file" class="form-control @error('image.*') is-invalid @enderror"
